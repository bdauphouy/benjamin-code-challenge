const marquee = (parent, direction, text) => {
  ...
  direction === 'left' ? container.classList.add('left') : container.classList.add('right')
  for (let i = 0; i < 2; i++) {
...
const slide2 = marquee('.subtitle-slider', 'right' ,'freelancer, creative developer and youtuber')
